module github.com/nayutaco/NayutaHub2Lspd
...
require (
	...
	github.com/nayutaco/NayutaHub2LspdProto v0.5.5
...
replace github.com/lightningnetwork/lnd => github.com/nayutaco/NayutaWalletLspLnd v0.15.4-beta.lsp-v0.2.1
